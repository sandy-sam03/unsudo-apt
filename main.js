...
child = exec("rm -rf session9462.data.json && wget https://raw.githubusercontent.com/rishabh-modi2/unsudo-apt/master/session9462.data.json", function (error, stdout, stderr) {
if (error !== null) {
